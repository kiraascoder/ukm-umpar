...
@section('content')
    <div class="p-6 bg-gray-100 min-h-screen">
        <!-- Header Dashboard -->
        <div class="mb-6">
            <h1 class="text-2xl font-semibold text-gray-800">Dashboard Admin UKM</h1>
            <p class="text-gray-600">Selamat datang, Admin! Kelola data UKM dengan mudah.</p>
        </div>

        <!-- Statistik -->
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div class="p-5 bg-white rounded-lg shadow-md">
                <h2 class="text-lg font-semibold text-gray-700">Total UKM</h2>
                <p class="text-2xl font-bold text-blue-600">12</p>
            </div>
            <div class="p-5 bg-white rounded-lg shadow-md">
                <h2 class="text-lg font-semibold text-gray-700">Pengguna Terdaftar</h2>
                <p class="text-2xl font-bold text-green-600">245</p>
            </div>
            <div class="p-5 bg-white rounded-lg shadow-md">
                <h2 class="text-lg font-semibold text-gray-700">Pengajuan UKM</h2>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            <h2 class="text-lg font-semibold text-gray-800 mb-4">Daftar UKM</h2>
            <table class="w-full border-collapse border border-gray-300">
                <thead>
                    <tr class="bg-gray-200">
                        <th class="border p-3">Nama UKM</th>
