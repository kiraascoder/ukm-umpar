<div class="relative">
    ...
    <nav class="container mx-auto px-6 py-4 flex justify-between items-center relative z-10">
        ...
        <div class="hidden md:flex space-x-10 text-white font-medium">
            ...
            <a href="/galeri" class="hover:text-yellow-300 transition">Galeri</a>
            <a href="/kegiatan" class="hover:text-yellow-300 transition">Kegiatan</a>
            <a href="/tentang" class="hover:text-yellow-300 transition">Tentang</a>
            <a href="/informasi" class="hover:text-yellow-300 transition">Informasi</a>
        </div>
        <div class="md:hidden" x-data="{ open: false }">
            ...
            <div x-show="open" @click.away="open = false"
                class="absolute top-20 right-6 bg-white shadow-lg rounded-lg p-6 w-48">
                <div class="flex flex-col space-y-4">
                    <a href="/" class="hover:text-yellow-500 transition">Home</a>
                    <a href="{{ route('galeri') }}" class="hover:text-yellow-500 transition">Galeri</a>
                    <a href="/kegiatan" class="hover:text-yellow-500 transition">Kegiatan</a>
                    <a href="/tentang" class="hover:text-yellow-500 transition">Tentang</a>
                    <a href="/informasi" class="hover:text-yellow-500 transition">Informasi</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <div class="container mx-auto px-6 pt-32 pb-48 relative z-10" x-data="{ fadeIn: false }" x-init="setTimeout(() => fadeIn = true, 500)">
        <div class="max-w-3xl transition-all duration-1000"
            ...
            <h1 class="text-4xl md:text-6xl font-bold text-white leading-tight mb-6">Where Imaginations <br>Come to Life
            </h1>
            <p class="text-xl text-white mb-8 md:pr-12">Premium vinyl playsets designed for endless adventures, built to
                last for generations of fun.</p>
