    ...
    <div class="container mx-auto px-4">
        <div class="flex items-center justify-between py-4">
            ...
            <div class="hidden sm:flex sm:items-center">
                <a href="#" class="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4">Daftar UKM</a>
                <a href="#" class="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4">Galeri</a>
                <a href="#" class="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4">Kegiatan</a>
                <a href="#" class="text-gray-800 text-sm font-semibold hover:text-purple-600">Tentang UKM</a>
            </div>
