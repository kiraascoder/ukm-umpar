...
@section('content')
    ...
    <div class="bg-gray-100 min-h-screen p-6" 
         x-data="{ openModal: null, selectedNama: '', deleteUrl: '', confirmText: '' }">
        ...
        <div x-cloak x-show="openModal"
            ...
            <div class="bg-white p-6 rounded-xl shadow-xl w-96">
                ...
                <p class="text-sm text-gray-600 mb-4">Ketik <strong>"HAPUS"</strong> untuk menghapus UKM <strong x-text="selectedNama"></strong>.</p>
                <input type="text" x-model="confirmText" class="w-full px-3 py-2 border rounded mb-4" placeholder="Ketik 'HAPUS'">
