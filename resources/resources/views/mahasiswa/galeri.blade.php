    ...
    <div class="mb-6" x-data="{ selectedImage: '{{ asset('storage/' . ($gallery->shuffle()->first()->photo_path ?? 'img/activity.jpg')) }}' }">
        <div class="container mx-auto px-4 py-8">
            ...
            <p class="text-gray-600 max-w-4xl text-center mx-auto mb-4">
                Potret semangat, kreativitas, dan kebersamaan mahasiswa dalam berbagai kegiatan Unit Kegiatan Mahasiswa
                (UKM).
                Dari ajang perlombaan, latihan rutin, hingga pengabdian masyarakat — setiap momen mencerminkan dedikasi
                mahasiswa
                dalam mengembangkan minat dan bakat di luar perkuliahan.
            </p>
